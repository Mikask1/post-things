...
export const Login = () => {
    ...
    useEffect(() =>
        setErrorMessage(authData?.authData?.message ? authData.authData?.message : "")
                    ...
                    <form onSubmit={handleSubmit}>
                        {!isSignup &&
                            <div className={classes.formInput + " " + classes.bottomLine}>
                                <TextField label="Email" name="email" variant="outlined" required onChange={handleFormChange} fullWidth className={classes.formContent} autoComplete="eh"></TextField>
                                <TextField label="Password" name="password" variant="outlined" required type="password" onChange={handleFormChange} fullWidth className={classes.formContent}></TextField>
                        ...
                        {isSignup &&
                            <div>
                                <div className={classes.formInput + " " + classes.bottomLine}>
                                    <TextField label="Username" variant="outlined" name="name" onChange={handleFormChange} fullWidth className={classes.formContent} required autoComplete="eh"></TextField>
                                    <TextField label="Email" variant="outlined" name="email" onChange={handleFormChange} fullWidth className={classes.formContent} required></TextField>
                                    <TextField label="Password" type="password" name="password" onChange={handleFormChange} variant="outlined" fullWidth className={classes.formContent} required></TextField>
                                    <TextField label="Re-enter Password" name="confirmPassword" type="password" onChange={handleFormChange} variant="outlined" fullWidth className={classes.formContent} required></TextField>
